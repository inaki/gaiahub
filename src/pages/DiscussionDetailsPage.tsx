  ...
  comments: [
    {
      ...
      content: 'Great idea! I can help organize the music and dancing part. I know several community members who play instruments and would love to participate.',
    ...
    },
    {
      ...
      content: 'I can lead a workshop on herbal medicine and wildcrafting. Would be perfect for the season!',
    ...
    },
    {
      ...
      content: "I'll coordinate the children's activities. Thinking of nature-based crafts and games.",
    ...
    <div className="container py-8">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div className="flex-1">
          <h1 className="text-3xl font-bold tracking-tight">{mockDiscussion.title}</h1>
          <div className="flex items-center gap-2 mt-1 text-muted-foreground">
            <Badge variant="outline">{mockDiscussion.community_name}</Badge>
            <span>•</span>
            <span className="text-sm">Started by {mockDiscussion.author.name}</span>
            <span>•</span>
            <span className="text-sm">{formatDate(mockDiscussion.created_at)}</span>
          </div>
        </div>
      </div>
          ...
          <Card className="mb-8">
            <CardContent className="pt-6">
              <div className="flex items-start gap-4">
                <Avatar>
                  <AvatarImage src={mockDiscussion.author.avatar} alt={mockDiscussion.author.name} />
            ...
            <CardContent>
              <div className="space-y-6">
                ...
                <div className="flex gap-4 pt-4">
                  <Avatar>
                    <AvatarImage src="https://images.pexels.com/photos/415829/pexels-photo-415829.jpeg" alt="Your Avatar" />
