    ...
    <div className="container py-8">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div className="flex-1">
          <h1 className="text-3xl font-bold tracking-tight">{mockDocument.title}</h1>
              ...
              <div className="space-y-4">
                <div className="space-y-1">
                  ...
                  <div className="flex items-center gap-2">
                    <Avatar>
                      <AvatarImage src={mockDocument.author.avatar} alt={mockDocument.author.name} />
                      <AvatarFallback>{mockDocument.author.name.charAt(0)}</AvatarFallback>
                    </Avatar>
                  ...
                  <div key={version.version} className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      <Avatar className="h-6 w-6">
                        <AvatarImage src={version.editor.avatar} alt={version.editor.name} />
                        <AvatarFallback>{version.editor.name.charAt(0)}</AvatarFallback>
                      </Avatar>
